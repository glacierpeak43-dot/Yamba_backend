...
class ForumCommentReplyReportController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'ForumCommentReplyReport';
    ...
    {
        $grid = new Grid(new ForumCommentReplyReport());
    ...
    {
        $show = new Show(ForumCommentReplyReport::findOrFail($id));
    ...
    {
        $form = new Form(new ForumCommentReplyReport());
