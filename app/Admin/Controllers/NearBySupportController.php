...
class NearBySupportController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new NearBySupport());
    ...
    {
        $show = new Show(NearBySupport::findOrFail($id));
    ...
    {
        $form = new Form(new NearBySupport());
