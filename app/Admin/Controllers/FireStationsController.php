...
class FireStationsController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new FireStations());
    ...
    {
        $show = new Show(FireStations::findOrFail($id));
    ...
    {
        $form = new Form(new FireStations());
