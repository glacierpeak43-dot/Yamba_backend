...
class ArticleCommentReplyReportController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'ArticleCommentReplyReport';
    ...
    {
        $grid = new Grid(new ArticleCommentReplyReport());
    ...
    {
        $show = new Show(ArticleCommentReplyReport::findOrFail($id));
    ...
    {
        $form = new Form(new ArticleCommentReplyReport());
