...
class PoliceContactsController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'PoliceContacts';
    ...
    {
        $grid = new Grid(new PoliceContacts());
    ...
    {
        $show = new Show(PoliceContacts::findOrFail($id));
    ...
    {
        $form = new Form(new PoliceContacts());
