...
class ArticleCommentReportController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'ArticleCommentReport';
    ...
    {
        $grid = new Grid(new ArticleCommentReport());
    ...
    {
        $show = new Show(ArticleCommentReport::findOrFail($id));

        $show->field('id', __('Id'));
        $show->field('user_id', __('User id'));
        $show->field('reportedBy.name', __('Reported by'));
    ...
    {
        $form = new Form(new ArticleCommentReport());

        $form->number('user_id', __('User id'));
        $form->number('reportedBy.name', __('Reported by'));
